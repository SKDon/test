...
(1, 2, CAST(0x07992A3C8C4218370B0000 AS DateTimeOffset), NEWID(), NULL, NULL, NULL, 5, 0, 5, NEWID(), CAST(0x07AA513C8C421D370B0000 AS DateTimeOffset), 6, 6.0000, 2, 1, 1, 11, NULL, 'f1', 'f1', 'f1@mail.ru', 'm1', 6),
(1, 2, CAST(0x0770263E8C4217370B0000 AS DateTimeOffset), NEWID(), NULL, NULL, NULL, 6, 1, 6, NEWID(), CAST(0x0770263E8C421C370B0000 AS DateTimeOffset), 7, 7.0000, 2, 0, 2, 12, 1, 'f1', 'f1', 'f1@mail.ru', 'm1', 7),
(1, 2, CAST(0x07C3E93E8C4216370B0000 AS DateTimeOffset), NEWID(), NULL, NULL, NULL, 7, 2, 7, NEWID(), CAST(0x07D4103F8C421B370B0000 AS DateTimeOffset), 8, 8.0000, 2, 1, 3, 13, NULL, 'f1', 'f1', 'f1@mail.ru', 'm1', 8),
(1, 2, CAST(0x0716AD3F8C4215370B0000 AS DateTimeOffset), NEWID(), NULL, NULL, NULL, 8, 3, 8, NEWID(), CAST(0x0727D43F8C421A370B0000 AS DateTimeOffset), 9, 9.0000, 2, 0, 4, 14, NULL, 'f1', 'f1', 'f1@mail.ru', 'm1', 9),
