...
EXEC msdb.dbo.sp_delete_database_backuphistory @database_name = N'Alicargo_Files_2_1'
GO
USE [master]
GO
ALTER DATABASE [Alicargo_Files_2_1] SET  SINGLE_USER WITH ROLLBACK IMMEDIATE
GO
USE [master]
GO
DROP DATABASE [Alicargo_Files_2_1]
GO
