...
namespace Alicargo.Controllers
{
    ...
    public partial class T4MVC_UserController : Alicargo.Controllers.UserController
    {
        ...
        public override System.Web.Mvc.ViewResult Index(Alicargo.Core.Enums.RoleType roleType)
        {
        ...
        partial void ListOverride(T4MVC_System_Web_Mvc_JsonResult callInfo, Alicargo.Core.Enums.RoleType roleType);

        public override System.Web.Mvc.JsonResult List(Alicargo.Core.Enums.RoleType roleType)
        {
        ...
        partial void EditOverride(T4MVC_System_Web_Mvc_ViewResult callInfo, Alicargo.Core.Enums.RoleType roleType, long id);

        public override System.Web.Mvc.ViewResult Edit(Alicargo.Core.Enums.RoleType roleType, long id)
        {
        ...
        partial void CreateOverride(T4MVC_System_Web_Mvc_ViewResult callInfo, Alicargo.Core.Enums.RoleType roleType);

        public override System.Web.Mvc.ViewResult Create(Alicargo.Core.Enums.RoleType roleType)
        {
