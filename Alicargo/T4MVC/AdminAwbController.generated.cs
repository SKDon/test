...
{
    public partial class AdminAwbController
    {
        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        protected AdminAwbController(Dummy d) { }
        ...
        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        public AdminAwbController Actions { get { return MVC.AdminAwb; } }
        [GeneratedCode("T4MVC", "2.0")]
        public readonly string Area = "";
        [GeneratedCode("T4MVC", "2.0")]
        public readonly string Name = "AdminAwb";
        [GeneratedCode("T4MVC", "2.0")]
        public const string NameConst = "AdminAwb";
    ...
    [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
    public partial class T4MVC_AdminAwbController : Alicargo.Controllers.Awb.AdminAwbController
    {
        public T4MVC_AdminAwbController() : base(Dummy.Instance) { }
