...
namespace Alicargo.DataAccess.Repositories.User
{
	public sealed class ForwarderRepository : IForwarderRepository
	{
		...
		public void UpdateForwarder(long id, string name, string login, string email)
		{
		...
		public void AddForwarder(long id, string name, string login, string email, string twoLetterISOLanguageName)
		{
