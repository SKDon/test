...
namespace Alicargo.BlackBox.Tests.Services.Application
{
	...
	public class ApplicationListPresenterTests
	{
		...
		{
			var application = _presenter.List(TwoLetterISOLanguageName.English, forwarderId: TestConstants.TestForwarderId1).Data
			...
			Assert.IsFalse(_presenter.List(TwoLetterISOLanguageName.English, forwarderId: TestConstants.TestForwarderId1).Data.Any(x => x.Id == application.Id));
		}
	}
}